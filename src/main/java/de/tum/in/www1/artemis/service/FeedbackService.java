...
public class FeedbackService {
     ...
     * @param postProcessMessages if the testErrors should be processed // ToDo: remove when post-processing can be unified for Bamboo and Jenkins
    ...
    public Feedback createFeedbackFromTestCase(String testName, List<String> testErrors, boolean successful, final ProgrammingLanguage programmingLanguage,
        ...
        if (!successful) {
            ...
            String errorMessageString = testErrors.stream().map(errorString -> {
                if (postProcessMessages) {
                    return processResultErrorMessage(programmingLanguage, errorString);
                }
                else {
                    return errorString;
                }
    ...
    private String processResultErrorMessage(final ProgrammingLanguage programmingLanguage, final String message) {
        if (programmingLanguage == ProgrammingLanguage.JAVA || programmingLanguage == ProgrammingLanguage.KOTLIN) {
            ...
            // TODO Improve this to support multi-line exceptions; a possible implementation exists in JenkinsService, but that does not work with Bamboo
