...
public class ArtemisInternalAuthenticationProvider extends ArtemisAuthenticationProviderImpl implements ArtemisAuthenticationProvider {
    ...
    public ArtemisInternalAuthenticationProvider(UserRepository userRepository, PasswordService passwordService, UserServiceProducer userServiceProducer) {
        super(userRepository, passwordService, userServiceProducer);
    }
    ...
    public User getOrCreateUser(Authentication authentication, String firstName, String lastName, String email, boolean skipPasswordCheck) {
        ...
        if (optionalUser.isEmpty()) {
            user = userServiceProducer.createInternalUser(authentication.getName(), password, null, firstName, lastName, email, null, null, "en", true);
        }
        else {
