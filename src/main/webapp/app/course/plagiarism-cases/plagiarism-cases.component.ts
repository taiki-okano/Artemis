...
export class PlagiarismCasesComponent implements OnInit {
    getIcon = getIcon;
    // TODO: group after exercise
    confirmedComparisons: PlagiarismComparison<PlagiarismSubmissionElement>[] = [];
    courseId: number;
    hideFinished = false;
    ...
    ngOnInit(): void {
        ...
        this.plagiarismCasesService.getConfirmedComparisons(this.courseId).subscribe((resp: HttpResponse<PlagiarismComparison<PlagiarismSubmissionElement>[]>) => {
