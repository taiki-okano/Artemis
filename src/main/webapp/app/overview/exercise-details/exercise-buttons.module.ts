...
@NgModule({
    imports: [SharedModule, ArtemisSharedComponentModule, ClipboardModule, MomentModule, ArtemisSharedPipesModule, ArtemisCoursesRoutingModule, OrionModule, FeatureToggleModule],
